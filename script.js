// File: script.js (Satu file untuk semua halaman)

// --- KONFIGURASI ---
// Ganti dengan URL Web App terbaru Anda
const webAppUrl = 'https://script.google.com/macros/s/AKfycbzJrMMjTi37jJc7Z8NB4RpBJCvjrRM7InSJiIKJWtygbFW0XgVTZUMOQrsCwtC5DzpncA/exec';
// --------------------
...
async function initLihatWpPage() {
    try {
        ...
        dataWilayahGlobal = data.wilayah || []; // Diperlukan untuk modal edit
...
async function initDetailPage() {
    ...
    const ketetapanTable = document.getElementById('ketetapanTable');
